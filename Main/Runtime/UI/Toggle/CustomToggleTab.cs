...
namespace RCore.UI
{
	...
	public class CustomToggleTab : Toggle
	{
		...
		[FormerlySerializedAs("m_hapticTouch")]
		public bool hapticTouch;
		...
		{
			if (p_pIsOn && !string.IsNullOrEmpty(sfxClip))
				EventDispatcher.Raise(new Audio.SFXTriggeredEvent(sfxClip));
			else if (!p_pIsOn && !string.IsNullOrEmpty(sfxClipOff))
		...
		public class CustomToggleTabEditor : UnityEditor.UI.ToggleEditor
		{
			...
			public override void OnInspectorGUI()
			{
				EditorGUILayout.BeginVertical("box");
				{
					...
					serializedObject.SerializeField("hapticTouch");
